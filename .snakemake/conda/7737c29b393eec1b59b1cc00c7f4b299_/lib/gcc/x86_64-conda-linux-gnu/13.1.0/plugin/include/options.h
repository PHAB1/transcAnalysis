...
enum opt_code
{
  ...
  OPT_mglibc = 1979,                         /* -mglibc */
  OPT_mhard_float = 1980,                    /* -mhard-float */
  OPT_mharden_sls_ = 1981,                   /* -mharden-sls= */
  OPT_mhle = 1982,                           /* -mhle */
  OPT_mhreset = 1983,                        /* -mhreset */
  OPT_miamcu = 1984,                         /* -miamcu */
  OPT_mieee_fp = 1985,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1986,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1987,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1988,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1989,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1990,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1991,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1992,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1993, */            /* -mintel-syntax */
  OPT_mkl = 1994,                            /* -mkl */
  OPT_mlam_ = 1995,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 1996,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1997,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1998,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1999,                /* -mlong-double-80 */
  OPT_mlwp = 2000,                           /* -mlwp */
  OPT_mlzcnt = 2001,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2002,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2003,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2004,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2005,                  /* -mmitigate-rop */
  OPT_mmmx = 2006,                           /* -mmmx */
  OPT_mmovbe = 2007,                         /* -mmovbe */
  OPT_mmovdir64b = 2008,                     /* -mmovdir64b */
  OPT_mmovdiri = 2009,                       /* -mmovdiri */
  OPT_mmove_max_ = 2010,                     /* -mmove-max= */
  OPT_mmpx = 2011,                           /* -mmpx */
  OPT_mms_bitfields = 2012,                  /* -mms-bitfields */
  OPT_mmusl = 2013,                          /* -mmusl */
  OPT_mmwait = 2014,                         /* -mmwait */
  OPT_mmwaitx = 2015,                        /* -mmwaitx */
  OPT_mneeded = 2016,                        /* -mneeded */
  OPT_mno_align_stringops = 2017,            /* -mno-align-stringops */
  OPT_mno_default = 2018,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2019,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2020,                  /* -mno-push-args */
  OPT_mno_red_zone = 2021,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2022,                       /* -mno-sse4 */
  OPT_mnop_mcount = 2023,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 2024,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 2025,                          /* -mpc32 */
  OPT_mpc64 = 2026,                          /* -mpc64 */
  OPT_mpc80 = 2027,                          /* -mpc80 */
  OPT_mpclmul = 2028,                        /* -mpclmul */
  OPT_mpcommit = 2029,                       /* -mpcommit */
  OPT_mpconfig = 2030,                       /* -mpconfig */
  OPT_mpku = 2031,                           /* -mpku */
  OPT_mpopcnt = 2032,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2033, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2034,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2035,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2036,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2037,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2038,                        /* -mprfchw */
  OPT_mptwrite = 2039,                       /* -mptwrite */
  OPT_mpush_args = 2040,                     /* -mpush-args */
  OPT_mraoint = 2041,                        /* -mraoint */
  OPT_mrdpid = 2042,                         /* -mrdpid */
  OPT_mrdrnd = 2043,                         /* -mrdrnd */
  OPT_mrdseed = 2044,                        /* -mrdseed */
  OPT_mrecip = 2045,                         /* -mrecip */
  OPT_mrecip_ = 2046,                        /* -mrecip= */
  OPT_mrecord_mcount = 2047,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2048,                 /* -mrecord-return */
  OPT_mred_zone = 2049,                      /* -mred-zone */
  OPT_mregparm_ = 2050,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2051,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2052,                           /* -mrtd */
  OPT_mrtm = 2053,                           /* -mrtm */
  OPT_msahf = 2054,                          /* -msahf */
  OPT_mserialize = 2055,                     /* -mserialize */
  OPT_msgx = 2056,                           /* -msgx */
  OPT_msha = 2057,                           /* -msha */
  OPT_mshstk = 2058,                         /* -mshstk */
  OPT_mskip_rax_setup = 2059,                /* -mskip-rax-setup */
  OPT_msoft_float = 2060,                    /* -msoft-float */
  OPT_msse = 2061,                           /* -msse */
  OPT_msse2 = 2062,                          /* -msse2 */
  OPT_msse2avx = 2063,                       /* -msse2avx */
  OPT_msse3 = 2064,                          /* -msse3 */
  OPT_msse4 = 2065,                          /* -msse4 */
  OPT_msse4_1 = 2066,                        /* -msse4.1 */
  OPT_msse4_2 = 2067,                        /* -msse4.2 */
  OPT_msse4a = 2068,                         /* -msse4a */
  /* OPT_msse5 = 2069, */                    /* -msse5 */
  OPT_msseregparm = 2070,                    /* -msseregparm */
  OPT_mssse3 = 2071,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2072,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2073, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2074,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2075, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2076,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2077,                  /* -mstackrealign */
  OPT_mstore_max_ = 2078,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2079,            /* -mstringop-strategy= */
  OPT_mstv = 2080,                           /* -mstv */
  OPT_mtbm = 2081,                           /* -mtbm */
  OPT_mtls_dialect_ = 2082,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2083,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2084,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2085,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2086,                         /* -mtune= */
  OPT_muclibc = 2087,                        /* -muclibc */
  OPT_muintr = 2088,                         /* -muintr */
  OPT_munroll_only_small_loops = 2089,       /* -munroll-only-small-loops */
  OPT_mvaes = 2090,                          /* -mvaes */
  OPT_mveclibabi_ = 2091,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2092,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2093,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2094,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2095,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2096,                      /* -mwbnoinvd */
  OPT_mwidekl = 2097,                        /* -mwidekl */
  OPT_mx32 = 2098,                           /* -mx32 */
  OPT_mxop = 2099,                           /* -mxop */
  OPT_mxsave = 2100,                         /* -mxsave */
  OPT_mxsavec = 2101,                        /* -mxsavec */
  OPT_mxsaveopt = 2102,                      /* -mxsaveopt */
  OPT_mxsaves = 2103,                        /* -mxsaves */
  OPT_n = 2104,                              /* -n */
  OPT_name_sort = 2105,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2106,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2107,              /* -no-integrated-cpp */
  OPT_no_pie = 2108,                         /* -no-pie */
  OPT_nocpp = 2109,                          /* -nocpp */
  OPT_nodefaultlibs = 2110,                  /* -nodefaultlibs */
  OPT_nolibc = 2111,                         /* -nolibc */
  OPT_nophoboslib = 2112,                    /* -nophoboslib */
  OPT_nostartfiles = 2113,                   /* -nostartfiles */
  OPT_nostdinc = 2114,                       /* -nostdinc */
  OPT_nostdinc__ = 2115,                     /* -nostdinc++ */
  OPT_nostdlib = 2116,                       /* -nostdlib */
  OPT_nostdlib__ = 2117,                     /* -nostdlib++ */
  OPT_o = 2118,                              /* -o */
  OPT_objects = 2119,                        /* -objects */
  OPT_p = 2120,                              /* -p */
  OPT_pass_exit_codes = 2121,                /* -pass-exit-codes */
  /* OPT_pedantic = 2122, */                 /* -pedantic */
  OPT_pedantic_errors = 2123,                /* -pedantic-errors */
  OPT_pg = 2124,                             /* -pg */
  OPT_pie = 2125,                            /* -pie */
  OPT_pipe = 2126,                           /* -pipe */
  OPT_posix = 2127,                          /* -posix */
  OPT_print_file_name_ = 2128,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2129,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2130,          /* -print-multi-directory */
  OPT_print_multi_lib = 2131,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2132,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2133,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2134,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2135,               /* -print-prog-name= */
  OPT_print_search_dirs = 2136,              /* -print-search-dirs */
  OPT_print_sysroot = 2137,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2138,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2139,                    /* -print-value */
  OPT_profile = 2140,                        /* -profile */
  OPT_pthread = 2141,                        /* -pthread */
  OPT_quiet = 2142,                          /* -quiet */
  OPT_r = 2143,                              /* -r */
  OPT_rdynamic = 2144,                       /* -rdynamic */
  OPT_remap = 2145,                          /* -remap */
  OPT_reverse_sort = 2146,                   /* -reverse-sort */
  OPT_s = 2147,                              /* -s */
  OPT_save_temps = 2148,                     /* -save-temps */
  OPT_save_temps_ = 2149,                    /* -save-temps= */
  OPT_shared = 2150,                         /* -shared */
  OPT_shared_libgcc = 2151,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2152,               /* -shared-libphobos */
  OPT_size_sort = 2153,                      /* -size-sort */
  /* OPT_specs = 2154, */                    /* -specs */
  OPT_specs_ = 2155,                         /* -specs= */
  OPT_static = 2156,                         /* -static */
  OPT_static_libasan = 2157,                 /* -static-libasan */
  OPT_static_libgcc = 2158,                  /* -static-libgcc */
  OPT_static_libgfortran = 2159,             /* -static-libgfortran */
  OPT_static_libgm2 = 2160,                  /* -static-libgm2 */
  OPT_static_libgo = 2161,                   /* -static-libgo */
  OPT_static_libhwasan = 2162,               /* -static-libhwasan */
  OPT_static_liblsan = 2163,                 /* -static-liblsan */
  OPT_static_libmpx = 2164,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2165,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2166,               /* -static-libphobos */
  OPT_static_libquadmath = 2167,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2168,               /* -static-libstdc++ */
  OPT_static_libtsan = 2169,                 /* -static-libtsan */
  OPT_static_libubsan = 2170,                /* -static-libubsan */
  OPT_static_pie = 2171,                     /* -static-pie */
  /* OPT_std_c__03 = 2172, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2173, */                /* -std=c++0x */
  OPT_std_c__11 = 2174,                      /* -std=c++11 */
  OPT_std_c__14 = 2175,                      /* -std=c++14 */
  OPT_std_c__17 = 2176,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2177, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2178, */                /* -std=c++1z */
  OPT_std_c__20 = 2179,                      /* -std=c++20 */
  OPT_std_c__23 = 2180,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2181, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2182, */                /* -std=c++2b */
  OPT_std_c__98 = 2183,                      /* -std=c++98 */
  OPT_std_c11 = 2184,                        /* -std=c11 */
  OPT_std_c17 = 2185,                        /* -std=c17 */
  /* OPT_std_c18 = 2186, */                  /* -std=c18 */
  /* OPT_std_c1x = 2187, */                  /* -std=c1x */
  OPT_std_c2x = 2188,                        /* -std=c2x */
  ...
  OPT_std_f95 = 2197,                        /* -std=f95 */
  OPT_std_gnu = 2198,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2199, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2200, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2201,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2202,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2203,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2204, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2205, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2206,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2207,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2208, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2209, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2210,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2211,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2212,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2213, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2214, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2215,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2216, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2217,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2218,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2219, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2220, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2221,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2222, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2223, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2224, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2225, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2226, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2227,                     /* -std=legacy */
  OPT_stdlib_ = 2228,                        /* -stdlib= */
  OPT_symbol_ = 2229,                        /* -symbol= */
  OPT_symbolic = 2230,                       /* -symbolic */
  OPT_t = 2231,                              /* -t */
  OPT_time = 2232,                           /* -time */
  OPT_time_ = 2233,                          /* -time= */
  OPT_tno_android_cc = 2234,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2235,                 /* -tno-android-ld */
  OPT_traditional = 2236,                    /* -traditional */
  OPT_traditional_cpp = 2237,                /* -traditional-cpp */
  OPT_tree_stats = 2238,                     /* -tree-stats */
  OPT_trigraphs = 2239,                      /* -trigraphs */
  OPT_type_stats = 2240,                     /* -type-stats */
  OPT_u = 2241,                              /* -u */
  OPT_undef = 2242,                          /* -undef */
  OPT_v = 2243,                              /* -v */
  OPT_version = 2244,                        /* -version */
  OPT_w = 2245,                              /* -w */
  OPT_wrapper = 2246,                        /* -wrapper */
  OPT_x = 2247,                              /* -x */
  OPT_z = 2248,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
